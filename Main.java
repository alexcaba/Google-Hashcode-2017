...
public class Main {
    ...
    public static void main(String[] args) throws IOException {
        ...
        try{
            Scanner in = new Scanner(new BufferedReader(new FileReader("videos_worth_spreading.in")));
            PrintWriter out = new PrintWriter(new BufferedWriter(new FileWriter("videos_worth_spreading.out")));
